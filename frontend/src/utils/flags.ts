...
const MID_TO_COUNTRY: Record<number, [string, string]> = {
  // A
  201: ['AL', 'Albania'], 202: ['AD', 'Andorra'], 203: ['AT', 'Austria'],
  204: ['PT', 'Azores'], 205: ['BE', 'Belgium'], 206: ['BY', 'Belarus'],
  207: ['BG', 'Bulgaria'], 208: ['VA', 'Vatican'], 209: ['CY', 'Cyprus'],
  210: ['CY', 'Cyprus'], 211: ['DE', 'Germany'], 212: ['CY', 'Cyprus'],
  213: ['GE', 'Georgia'], 214: ['MD', 'Moldova'], 215: ['MT', 'Malta'],
  216: ['AM', 'Armenia'], 218: ['DE', 'Germany'], 219: ['DK', 'Denmark'],
  220: ['DK', 'Denmark'], 224: ['ES', 'Spain'], 225: ['ES', 'Spain'],
  ...
  247: ['IT', 'Italy'], 248: ['MT', 'Malta'], 249: ['MT', 'Malta'],
  250: ['IE', 'Ireland'], 251: ['IS', 'Iceland'], 252: ['LI', 'Liechtenstein'],
  253: ['LU', 'Luxembourg'], 254: ['MC', 'Monaco'], 255: ['PT', 'Madeira'],
  ...
  266: ['SE', 'Sweden'], 267: ['SK', 'Slovakia'], 268: ['SM', 'San Marino'],
  ...
  // B
  301: ['AI', 'Anguilla'], 303: ['US', 'Alaska'], 304: ['AG', 'Antigua and Barbuda'],
  305: ['AG', 'Antigua and Barbuda'], 306: ['CW', 'Curacao'],
  307: ['AW', 'Aruba'], 308: ['BS', 'Bahamas'], 309: ['BS', 'Bahamas'],
  310: ['BM', 'Bermuda'], 311: ['BS', 'Bahamas'], 312: ['BZ', 'Belize'],
  314: ['BB', 'Barbados'], 316: ['CA', 'Canada'],
  319: ['KY', 'Cayman Islands'], 321: ['CR', 'Costa Rica'],
  ...
  350: ['NI', 'Nicaragua'], 351: ['PA', 'Panama'], 352: ['PA', 'Panama'],
  353: ['PA', 'Panama'], 354: ['PA', 'Panama'], 355: ['PA', 'Panama'],
  ...
  373: ['PA', 'Panama'], 374: ['PA', 'Panama'], 375: ['VC', 'Saint Vincent and the Grenadines'],
  ...
  410: ['BT', 'Bhutan'], 412: ['CN', 'China'], 413: ['CN', 'China'],
  414: ['CN', 'China'], 416: ['TW', 'Taiwan'],
  417: ['LK', 'Sri Lanka'], 419: ['IN', 'India'],
  422: ['IR', 'Iran'], 423: ['AZ', 'Azerbaijan'],
  425: ['IQ', 'Iraq'], 428: ['IL', 'Israel'],
  ...
  447: ['KW', 'Kuwait'], 450: ['LB', 'Lebanon'],
  451: ['KG', 'Kyrgyzstan'], 453: ['MO', 'Macao'],
  455: ['MV', 'Maldives'], 457: ['MN', 'Mongolia'],
  459: ['NP', 'Nepal'], 461: ['OM', 'Oman'],
  463: ['PK', 'Pakistan'], 466: ['QA', 'Qatar'],
  468: ['SY', 'Syria'], 470: ['AE', 'United Arab Emirates'],
  ...
  523: ['CC', 'Cocos Islands'], 525: ['ID', 'Indonesia'],
  ...
  665: ['SH', 'Saint Helena'], 666: ['SO', 'Somalia'],
  ...
  740: ['FK', 'Falkland Islands'], 745: ['GF', 'French Guiana'],
  750: ['GY', 'Guyana'], 755: ['PY', 'Paraguay'],
  760: ['PE', 'Peru'], 765: ['SR', 'Suriname'],
  770: ['UY', 'Uruguay'], 775: ['VE', 'Venezuela'],
}

/** Get flag image URL and country name from MMSI */
export function getFlagFromMmsi(mmsi: number): { code: string; country: string; flagUrl: string } | null {
  const mid = Math.floor(mmsi / 1_000_000)
  const entry = MID_TO_COUNTRY[mid]
